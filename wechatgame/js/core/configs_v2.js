const MAPS = {
  TRIANGLE: { id: "TRIANGLE", name: "等腰三角形", sides: 3, radius: 600 },
...
const BALLS = [
  ...
  ball("B07_SAW", { radius: 27, mass: 1.04 }, { type: "ring", damage: 70, hitInterval: 0.16, radius: 44, impulse: 34, ringBodyKnockback: true, ringWeaponIgnore: true, crit: { midRate: 0.17, midMultiplier: 2, highRate: 0.07, highMultiplier: 3 }, maxCount: 1 }),
